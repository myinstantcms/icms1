...
////////////////////////////////////////////////////////////////////////////////
    /**
     * Читает конфигурацию непосредственно из файла (а не из кеша инстанса).
     * Нужна, когда важно не затереть сохранённые настройки устаревшим
     * состоянием инстанса (например, во время установки).
     * @param string $file
     * @return array
     */
    public static function getConfigFromFile($file = 'config.inc.php') {

        $path = PATH . '/includes/' . $file;
        ...
        return is_array($_CFG) ? $_CFG : array();
    }
