...
$_LANG['INS_DB_NAME_INVALID']        = 'Invalid database name: only latin letters, digits, "-" and "_" allowed.';
...
$_LANG['INS_DB_STEP_HINT']         = 'Enter the MySQL server parameters. If the database does not exist yet, tick the create box and the installer will make it.';
