...
CREATE TABLE `#__board_items` (
  ...
  `formsdata` text NOT NULL DEFAULT '',
...
(8, 'deleteOldNotification', 48, '2016-06-30 23:19:42', 'users', 'deleteOldNotification', '', 1, 1, 'Удаляет сообщения службы обновлений и рассылки старее 1 месяца', '', ''),
...
INSERT INTO `#__forums` (`id`, `category_id`, `title`, `description`, `access_list`, `ordering`, `published`, `parent_id`, `NSLeft`, `NSRight`, `NSDiffer`, `NSIgnore`, `NSLevel`, `icon`, `topic_cost`, `thread_count`, `post_count`, `last_msg`, `moder_list`) VALUES
...
(10, 1, 'Закат на пляже', '', '2016-06-30 18:26:43', 'd0633d5a84f03a27f1b7d0419947e968.jpg', 1, 25, 1, 1, 1, 'photos'),
(11, 1, 'Флорида', '', '2016-06-30 18:27:33', '5e7a09ffcaa383df24d25d56c315f0d0.jpg', 1, 28, 1, 1, 1, 'photos'),
